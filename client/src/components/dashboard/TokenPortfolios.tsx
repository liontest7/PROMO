...
export const TokenPortfolios = ({ tokenBalances }: TokenPortfoliosProps) => (
  <section>
    ...
    {tokenBalances && tokenBalances.length > 0 ? (
      ...
      <div className="flex flex-col items-center justify-center p-8 rounded-[2rem] bg-white/[0.02] border border-dashed border-white/10 group hover:border-primary/40 transition-all duration-500 shadow-inner flex-1 min-h-[220px] relative z-10">
