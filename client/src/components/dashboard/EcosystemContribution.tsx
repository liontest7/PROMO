...
export const EcosystemContribution = ({ reputationScore, level, progress }: EcosystemContributionProps) => (
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-end">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-black text-primary/60 uppercase tracking-widest">{reputationScore} Points</span>
