    ...
    <Card className="glass-card border-white/10 bg-white/[0.02] rounded-[2rem] shadow-xl overflow-hidden">
      <CardHeader className="p-8 pb-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <CardTitle className="text-2xl font-black font-display uppercase italic tracking-tight text-white flex items-center gap-3">
            <Users className="w-6 h-6 text-primary" />
            Referral <span className="text-primary">Protocol</span>
          </CardTitle>
          
          <div className="flex bg-primary/10 border border-primary/20 px-6 py-3 rounded-2xl items-center gap-4">
            <div className="text-right">
              <p className="text-[10px] text-primary font-black uppercase tracking-widest opacity-80">Weekly Share</p>
              <p className="text-2xl font-black font-display text-primary leading-none mt-1">0%</p>
            </div>
            <div className="w-px h-8 bg-primary/20" />
            <div className="text-right">
              <p className="text-[10px] text-white font-black uppercase tracking-widest opacity-60">Total Invites</p>
              <p className="text-2xl font-black font-display text-white leading-none mt-1">{referralCount}</p>
            </div>
          </div>
        </div>
      </CardHeader>
      ...
      <CardContent className="p-8 pt-2 space-y-10">
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <p className="text-xs text-white/60 font-black uppercase tracking-widest">Growth Ambassador Link</p>
            <span className="text-[10px] text-primary font-bold uppercase italic tracking-tight">Earn 100 XP per active referral</span>
          </div>
          <div className="flex gap-3">
            <div className="relative flex-1">
              <Input 
                value={referralLink} 
                readOnly 
                className="bg-black/40 border-white/10 text-white font-mono text-sm h-14 rounded-2xl pl-4 pr-12 focus-visible:ring-primary/50"
              />
              <Users className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-white/20" />
            </div>
            <Button size="icon" onClick={copyToClipboard} className="shrink-0 h-14 w-14 rounded-2xl bg-primary hover:bg-primary/80 text-black shadow-[0_0_20px_rgba(34,197,94,0.3)] transition-all active:scale-95">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between border-b border-white/5 pb-4">
            ...
            <span className="text-[10px] text-white/40 font-bold uppercase tracking-widest">Live Updates</span>
          </div>
        ...
        <div className="pt-4 border-t border-white/5 text-center">
          <p className="text-[11px] text-white/40 font-bold uppercase tracking-tight italic leading-relaxed">
            Ambassadors receive rewards once their recruits complete their first task.
          </p>
        </div>
      </CardContent>
    </Card>
