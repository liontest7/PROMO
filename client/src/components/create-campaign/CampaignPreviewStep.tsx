...
export function CampaignPreviewStep({ form, isPending, onBack, onSubmit }: CampaignPreviewStepProps) {
      ...
      <div className="p-6 bg-primary/5 border border-primary/20 rounded-3xl space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-display text-lg text-white">Campaign Summary</h3>
          </div>
          <Badge variant="outline" className="bg-primary/10 text-primary border-primary/20 font-black uppercase tracking-widest text-[10px]">
            {watchedType === "engagement" ? "Social Engagement" : "Holder Qualification"}
          </Badge>
        </div>
        ...
        <div className="space-y-3 pt-2">
          <div className="flex justify-between items-center text-sm">
            ...
            <span className="text-primary font-bold">{totalProjectTokenCost.toFixed(4)} PROJECT</span>
          </div>
          <div className="flex justify-between items-center text-sm">
          ...
          <div className="flex justify-between items-center">
            <span className="text-white font-black uppercase tracking-widest text-xs">Total to Pay</span>
            <div className="text-right">
              <div className="text-lg font-display text-primary">{totalProjectTokenCost.toFixed(4)} PROJECT</div>
              <div className="text-[10px] text-white/40 font-mono">+{gasFeeSol} SOL</div>
            </div>
          </div>
        </div>
      </div>
