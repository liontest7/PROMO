...
export function CampaignEditStep({
  form,
  settings,
  loadingSettings,
}: CampaignEditStepProps) {
    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-white/[0.02] border border-white/5 rounded-3xl">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-primary font-black uppercase tracking-widest text-[10px]">
                Token Mint Address
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              >
                <FormControl>
                  <SelectTrigger className="h-12 bg-primary/5 border-primary/20 font-black uppercase tracking-widest text-xs text-white">
                ...
                <SelectContent className="bg-black border-white/10">
                  <SelectItem
                    ...
                    className="font-black uppercase tracking-widest text-xs py-3 text-white"
                  >
      ...
      {watchedType && (
        <div className="space-y-8 animate-in fade-in slide-in-from-top-4 duration-500">
          <div className="space-y-6 p-6 bg-white/[0.02] border border-white/5 rounded-3xl">
            <h3 className="text-primary font-black uppercase tracking-widest text-[10px] mb-4">
              Project Details
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[10px] uppercase font-black text-white/40">
                      Campaign Title
                    </FormLabel>
                    <FormControl>
                      <Input
          ...
          {watchedType === "engagement" ? (
            <div className="space-y-4 p-6 bg-white/[0.02] border border-white/5 rounded-3xl">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-primary font-black uppercase tracking-widest text-[10px]">
                  Campaign Actions
                </h3>
                <Button
                  type="button"
                  ...
                  className="h-8 border-primary/20 text-primary hover:bg-primary/10 font-black uppercase tracking-widest text-[10px]"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6 bg-white/[0.02] border border-white/5 rounded-3xl">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[10px] uppercase font-black text-white">
                      Reward per Holder
                    </FormLabel>
                    <FormControl>
                      <Input
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[10px] uppercase font-black text-white/40">
                      <Twitter className="w-3 h-3 inline mr-1" /> Twitter
                    </FormLabel>
                    <FormControl>
                      <Input
