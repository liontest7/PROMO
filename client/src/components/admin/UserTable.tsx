          ...
          <TableRow key={user.id} className="border-white/5 hover:bg-white/[0.02] transition-colors">
            ...
            <TableCell className="text-right pr-8">
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button 
                          size="sm" 
                          variant="outline" 
                          className="h-8 border-white/10 font-black text-xs uppercase tracking-widest"
                        >
                ...
                <Button 
                  size="sm" 
                  variant="ghost"
                  className="h-8 text-xs font-black uppercase hover:bg-primary/10 hover:text-primary tracking-widest"
