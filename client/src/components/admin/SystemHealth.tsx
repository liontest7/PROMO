    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <Card className="glass-card border-white/10 bg-white/[0.01] rounded-2xl">
          ...
          <CardContent>
            <div className="text-2xl font-black font-display text-white">{((health?.memory?.rss || 0) / 1024 / 1024).toFixed(1)} MB</div>
            <p className="text-[10px] text-white mt-1 uppercase font-black tracking-widest">Memory Usage (RSS)</p>
          </CardContent>
        </Card>
        ...
        <Card className="glass-card border-white/10 bg-white/[0.01] rounded-2xl">
          ...
          <CardContent>
            ...
            <p className="text-[10px] text-white mt-1 uppercase font-black tracking-widest">PostgreSQL Connectivity</p>
          </CardContent>
        </Card>
        ...
        <Card className="glass-card border-white/10 bg-white/[0.01] rounded-2xl">
          ...
          <CardContent>
            ...
            <p className="text-[10px] text-white mt-1 uppercase font-black tracking-widest">Mainnet-Beta Status</p>
          </CardContent>
        </Card>
      </div>
