...
function EarnContentOnly({ settings }: { settings: any }) {
  ...
  if (activeCampaigns.length === 0) {
    return (
      <div className="col-span-full py-12 text-center bg-white/5 rounded-[2rem] border border-white/5 backdrop-blur-sm">
        <Rocket className="w-12 h-12 text-primary/40 mx-auto mb-4" />
        <h3 className="text-xl font-bold text-white mb-2 uppercase tracking-tighter">No Active Campaigns</h3>
        <p className="text-white/60 max-w-md mx-auto">The system is waiting for new projects to launch. Check back soon or launch your own project to start the movement.</p>
      </div>
    );
  }
              ...
              <div className="grid md:grid-cols-2 gap-16 items-center">
                <div>
                  ...
                  <p className="text-xl text-white/80 mb-10 leading-relaxed font-medium">
                    We don't just grow communities; we strengthen the entire ecosystem. Every campaign created requires a 1 SOL fee, which is automatically distributed:
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <div className="p-6 bg-black/40 rounded-[2rem] border border-primary/20 backdrop-blur-md group hover:border-primary/50 transition-all text-center">
                      <p className="text-3xl font-black text-primary mb-2">40%</p>
                      <p className="text-[11px] text-white/80 uppercase font-black tracking-widest">Tasks Rewards</p>
                    </div>
                    <div className="p-6 bg-black/40 rounded-[2rem] border border-primary/20 backdrop-blur-md group hover:border-primary/50 transition-all text-center">
                      <p className="text-3xl font-black text-primary mb-2">40%</p>
                      <p className="text-[11px] text-white/80 uppercase font-black tracking-widest">Referral Rewards</p>
                    </div>
