      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
                  ...
                  <div className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/10">
                    <div className="flex items-center space-x-4">
                      ...
                      <Label htmlFor="campaigns-enabled" className="flex flex-col">
                        ...
                        <span className="text-sm text-white font-black">{settings?.campaignsEnabled ? 'Enabled' : 'Disabled'}</span>
                      </Label>
                    </div>
                  </div>
        ...
        <Tabs defaultValue="users" className="w-full">
          <div className="flex flex-col md:flex-row items-center justify-between mb-4 gap-4">
            <TabsList className="bg-white/5 border border-white/10 p-2 rounded-xl w-full md:w-auto h-auto gap-2">
              <TabsTrigger value="users" className="flex-1 md:flex-none rounded-lg px-6 py-3 font-black uppercase text-[15px] tracking-widest data-[state=active]:bg-white data-[state=active]:text-black text-white hover:text-white transition-all">USERS</TabsTrigger>
